...
describe("Alpha-8 Phase 1B docs map", () => {
  it("records storage model and explicit exclusions", () => {
    ...
    expect(docsMapSource).toContain("No production SQL run");
    expect(docsMapSource).toContain("No production migration applied");
    expect(docsMapSource).toContain("No production deploy");
